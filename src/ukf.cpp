...
void UKF::UpdateState(MatrixXd &Zsig, VectorXd &z_pred, MatrixXd &S, VectorXd &z, MeasurementPackage::SensorType sensor_type) 
{
...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) 
{
  ...
  { 
    // Make prediction and update with new measurement
...
{  
  ...
  UpdateState(Zsig_las, z_pred_las, S_las, meas_package.raw_measurements_, MeasurementPackage::LASER);
}
...
void UKF::UpdateRadar(MeasurementPackage meas_package) 
{
  ...
  UpdateState(Zsig_rad, z_pred_rad, S_rad, meas_package.raw_measurements_, MeasurementPackage::RADAR);
}